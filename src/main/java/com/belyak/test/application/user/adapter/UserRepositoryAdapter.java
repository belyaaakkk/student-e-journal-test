package com.belyak.test.application.user.adapter;
...
import com.belyak.test.infrastructure.persistence.mapper.UserMapper;
import com.belyak.test.infrastructure.persistence.repository.JpaUserRepository;
